...
export interface Client {
   ...
   */
  create_bounty: ({owner, token, reward, distribution, submission_deadline, title}: {owner: string, token: string, reward: i128, distribution: Array<readonly [u32, u32]>, submission_deadline: u64, title: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
