...
export type Status = {tag: "Active", values: void} | {tag: "Completed", values: void} | {tag: "Closed", values: void};
...
export interface Client {
   ...
   */
  get_bounty: ({bounty_id}: {bounty_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Bounty>>>
   ...
   */
  close_bounty: ({owner, bounty_id}: {owner: string, bounty_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  get_bounties: (options?: MethodOptions) => Promise<AssembledTransaction<Array<u32>>>
   ...
   */
  update_admin: ({new_admin}: {new_admin: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<string>>>
   ...
   */
  check_judging: ({bounty_id}: {bounty_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  create_bounty: ({owner, token, reward, distribution, submission_deadline, judging_deadline, title}: {owner: string, token: string, reward: i128, distribution: Array<readonly [u32, u32]>, submission_deadline: u64, judging_deadline: u64, title: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<u32>>>
   ...
   */
  delete_bounty: ({owner, bounty_id}: {owner: string, bounty_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  update_bounty: ({owner, bounty_id, new_title, new_distribution, new_submission_deadline}: {owner: string, bounty_id: u32, new_title: Option<string>, new_distribution: Array<readonly [u32, u32]>, new_submission_deadline: Option<u64>}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  get_submission: ({bounty_id, user}: {bounty_id: u32, user: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<string>>>
   ...
   */
  select_winners: ({owner, bounty_id, winners}: {owner: string, bounty_id: u32, winners: Array<string>}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  apply_to_bounty: ({applicant, bounty_id, submission_link}: {applicant: string, bounty_id: u32, submission_link: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  get_bounty_status: ({bounty_id}: {bounty_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Status>>>
   ...
   */
  get_user_bounties: ({user}: {user: string}, options?: MethodOptions) => Promise<AssembledTransaction<Array<u32>>>
   ...
   */
  update_submission: ({applicant, bounty_id, new_submission_link}: {applicant: string, bounty_id: u32, new_submission_link: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  get_bounties_count: (options?: MethodOptions) => Promise<AssembledTransaction<u32>>
   ...
   */
  get_bounty_winners: ({bounty_id}: {bounty_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Array<string>>>>
   ...
   */
  get_owner_bounties: ({owner}: {owner: string}, options?: MethodOptions) => Promise<AssembledTransaction<Array<u32>>>
   ...
   */
  update_fee_account: ({new_fee_account}: {new_fee_account: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<string>>>
   ...
   */
  get_active_bounties: (options?: MethodOptions) => Promise<AssembledTransaction<Array<u32>>>
   ...
   */
  get_bounties_by_token: ({token}: {token: string}, options?: MethodOptions) => Promise<AssembledTransaction<Array<u32>>>
   ...
   */
  get_bounty_applicants: ({bounty_id}: {bounty_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Array<string>>>>
   ...
   */
  get_bounties_by_status: ({status}: {status: Status}, options?: MethodOptions) => Promise<AssembledTransaction<Array<u32>>>
   ...
   */
  get_bounty_submissions: ({bounty_id}: {bounty_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Map<string, string>>>>
   ...
   */
  get_user_bounties_count: ({user}: {user: string}, options?: MethodOptions) => Promise<AssembledTransaction<u32>>
   ...
   */
  get_owner_bounties_count: ({owner}: {owner: string}, options?: MethodOptions) => Promise<AssembledTransaction<u32>>
   ...
   */
  get_bounties_by_token_count: ({token}: {token: string}, options?: MethodOptions) => Promise<AssembledTransaction<u32>>
   ...
   */
  get_bounties_by_status_count: ({status}: {status: Status}, options?: MethodOptions) => Promise<AssembledTransaction<u32>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAKZ2V0X2JvdW50eQAAAAAAAQAAAAAAAAAJYm91bnR5X2lkAAAAAAAABAAAAAEAAAPpAAAH0AAAAAZCb3VudHkAAAAAAAM=",
