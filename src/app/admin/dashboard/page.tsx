  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // Get recent bounties
        const recentBountiesQuery = query(bountiesRef, orderBy('createdAt', 'desc'), limit(5));
        ...
        const recentSubmissionsQuery = query(submissionsRef, orderBy('createdAt', 'desc'), limit(5));
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                ...
                <p className="mt-1 text-white/60">Manage bounties, users, and submissions</p>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 backdrop-blur-xl border border-white/20 rounded-xl p-6">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-medium text-white/80">Total Bounties</h3>
                ...
                <Link href="/admin/bounties" className="mt-4 inline-flex items-center text-sm text-blue-400 hover:text-blue-300">
                  View All
              ...
              <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-xl border border-white/20 rounded-xl p-6">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-medium text-white/80">Active Bounties</h3>
                ...
                <p className="text-3xl font-bold mt-4">{stats?.activeBounties || 0}</p>
                <Link href="/admin/bounties?status=active" className="mt-4 inline-flex items-center text-sm text-green-400 hover:text-green-300">
                  View Active
                  <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
              ...
              <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-xl border border-white/20 rounded-xl p-6">
                ...
                <Link href="/admin/users" className="mt-4 inline-flex items-center text-sm text-purple-400 hover:text-purple-300">
                  Manage Users
                  <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
              ...
              <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-xl border border-white/20 rounded-xl p-6">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-medium text-white/80">Total Submissions</h3>
                ...
                <p className="text-3xl font-bold mt-4">{stats?.totalSubmissions || 0}</p>
                <Link href="/admin/submissions" className="mt-4 inline-flex items-center text-sm text-orange-400 hover:text-orange-300">
                  View Submissions
                  <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-xl p-6">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <Link href="/admin/bounties" className="text-sm text-blue-400 hover:text-blue-300 flex items-center">
                    View All
                    <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                ...
                {recentBounties.length > 0 ? (
                  <div className="space-y-4">
                    {recentBounties.map((bounty) => (
                      <div key={bounty.id} className="flex items-center justify-between p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
                        <div>
                          <Link href={`/bounties/${bounty.id}`} className="font-medium hover:text-blue-400 transition-colors">
                            {bounty.title}
                          </Link>
                        ...
                        <span className={`px-3 py-1 text-xs rounded-full ${
                          ...
                          bounty.status === 'COMPLETED' ? 'bg-blue-900/40 text-blue-300 border border-blue-700/30' :
              ...
              <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-xl p-6">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <Link href="/admin/submissions" className="text-sm text-blue-400 hover:text-blue-300 flex items-center">
                    View All
                    <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                ...
                {recentSubmissions.length > 0 ? (
                  <div className="space-y-4">
                    {recentSubmissions.map((submission) => (
                      <div key={submission.id} className="flex items-center justify-between p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
                        <div>
                          <Link href={`/bounties/${submission.bountyId}`} className="font-medium hover:text-blue-400 transition-colors">
                        ...
                        <span className={`px-3 py-1 text-xs rounded-full ${
                          submission.status === 'COMPLETED' ? 'bg-green-900/40 text-green-300 border border-green-700/30' :
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-sm text-white/60">Create and publish a new bounty for the community</p>
              </Link>
              ...
              >
                ...
                <p className="text-sm text-white/60">View and manage user accounts and permissions</p>
              </Link>
