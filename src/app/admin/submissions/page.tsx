                ...
                <tbody className="divide-y divide-white/20">
                  {submissions.map((submission) => (
                    <tr key={submission.id} className="hover:bg-white/5">
                      <td className="py-4">{submission.bountyTitle || `Bounty #${submission.bountyId}`}</td>
                      ...
                      <td className="py-4">{new Date(submission.createdAt).toLocaleDateString()}</td>
                      <td className="py-4">{submission.ranking || '-'}</td>
                      <td className="py-4">
                        <button
                          onClick={() => window.location.href = `/bounties/${submission.bountyId}`}
