...
export default function Home() {
  ...
  const stats = [
    { label: 'Active Bounties', value: '200+' },
    { label: 'Contributors', value: '5,000+' },
    { label: 'Rewards Paid', value: '$1.2M+' },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.05, y: -4, backgroundColor: 'rgba(255, 255, 255, 0.2)' }}
                transition={{
                  type: 'spring',
                  stiffness: 120,
                  damping: 14,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => (
              <motion.div
                ...
                whileHover={{ y: -8, boxShadow: '0 8px 30px rgba(255,255,255,0.15)' }}
