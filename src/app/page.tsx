...
export default function Home() {
  // Using any type temporarily to handle the difference between Firestore data and our type definitions
                        ...
                        <span className="text-sm text-white/60">
                          {bounty.createdAt?.seconds
                            ? `Posted ${formatDistanceToNow(
                                new Date(bounty.createdAt.seconds * 1000),
                                { addSuffix: true }
                              )}`
                            : bounty.created
                            ? `Posted ${formatDistanceToNow(
                                new Date(bounty.created),
                                { addSuffix: true }
                              )}`
                            : 'Recently posted'}
                        </span>
