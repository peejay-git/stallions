...
export default function SubmitWorkForm({ bountyId, submissionDeadline }: SubmitWorkFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        console.log('Generated blockchain submission ID:', blockchainSubmissionId);
      ...
      const error = err instanceof Error ? err : new Error('Failed to submit work');
